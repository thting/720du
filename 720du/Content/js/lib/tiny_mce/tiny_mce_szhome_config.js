tinyMCE.init({
   ...
   // height:"400px",
    ...
    theme_advanced_buttons1: "bold,italic,underline,|,image,uploadImage,|,formatselect,fontselect,fontsizeselect,|,justifyleft, justifycenter, justifyright,|,link,unlink,|,code,preview",
